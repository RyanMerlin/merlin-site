<script context="module">
  export const metadata = {
    ...
    summary: "How Aria uses the Infisical Rust SDK to replace .env credential management with a live, bidirectional, auditable secrets backbone — and why that matters for always-on agents."
  };
</script>
