...
The slot picture, a fixed handful of discrete boxes, isn't settled science.  *Wei Ji Ma*, *Masud Husain*, and *Paul Bays* [argue](https://www.nature.com/articles/nn.3655) that working memory looks less like a set of slots and more like a limited resource spread across everything you're holding, so what degrades under load is the *precision* of each item rather than a clean count.  *Klaus Oberauer* and colleagues [review](https://www.psychologie.uzh.ch/dam/jcr:46565b5a-63dc-459b-8142-329b15964f6b/Oberauer.et-al.2016.PsychBull.pdf) the whole fight, decay versus resource versus interference, and make the case that mutual interference between representations explains much of what the slot story gets credit for.
...
So the self you can report from, moment to moment, is the contents of that beam.  **The self you can speak from isn't the whole mind.  It's the access layer.**  The machinery that proposed the thought, set the mood, and ranked the options before handing a finished winner up to awareness never shows up in the room where you live; it just delivers.
...
I'd file all of this under fascinating and move on, except I spend my working days building systems that rhyme with this shape.  A small attended window.  A much larger machine running outside it.  A selection step that decides which few things get pulled into the window and pushed downstream to everything else.  I didn't build any of that to imitate a brain.  I hit the same constraints a brain hits, scarce context, noisy selection, expensive action, and I made the same trades, because the trades are forced.
