...
I'm an AI developer and forward deployed engineer — embedded with enterprise organizations shipping production AI systems. My independent research is focused on [EdgePlane](https://github.com/RyanMerlin/edgeplane) — a multi-agent orchestration framework built around what actually matters in production: task durability, inter-agent coordination, and evaluation frameworks that catch failure modes before they reach customers.
...
**Stack:** Astro 5 · React 19 islands · Tailwind CSS 4 · Cloudflare Pages · deployed via GitHub Actions
